...
<div class="<?= $this->e($type, "wrapperClasses") ?>"<?php echo !empty(
  ...
  : ""; ?>>
    <div class="vssl-stripe-column">
        ...
        <h2 class="vssl-stripe--related--label"><?= $relatedLabel[
          "html"
        ] ?></h2>
        <?php endif; ?>
                    ...
                    <a href="<?= $link["page"]["slug"] ?>" target="_blank">
                        ...
                        <div class="vssl-stripe--related--text">
                            <div class="vssl-stripe--related--page-info">
                                <h3 class="vssl-stripe--related--title"><?= $link[
                                  "page"
                                ]["title"] ?></h3>
                                <p class="vssl-stripe--related--description"><?= $link[
                                  "page"
                                ]["summary"] ?></p>
                            </div>
                            <p class="vssl-stripe--related--url"><?= $_SERVER[
                              "SERVER_NAME"
                            ] . $link["page"]["slug"] ?></p>
                        </div>
                    </a>
