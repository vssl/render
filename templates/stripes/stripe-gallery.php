...
<div class="<?= $this->e($type, "wrapperClasses") ?>"<?php echo !empty(
  ...
  : ""; ?>>
    <div class="vssl-stripe-column">
        <div class="vssl-stripe--gallery--wrap" data-slide-count="<?= count(
          $slides
        ) ?>">
            <div class="vssl-stripe--gallery--slides">
                ...
                <div class="vssl-stripe--gallery--slide">
                    ...
                    <?php if (
                      !empty($slide["caption"]["html"]) ||
                      !empty($slide["credit"]["html"]) ||
                      count($slides) > 1
                    ): ?>
                    <div class="vssl-stripe--gallery--meta">
                        <?php if (!empty($slide["caption"]["html"])): ?>
                        <div class="vssl-stripe--gallery--caption"><?= $this->inline(
                          $slide["caption"]["html"]
                        ) ?></div>
                        <?php endif; ?>

                        <?php if (!empty($slide["credit"]["html"])): ?>
                        <div class="vssl-stripe--gallery--credit"><?= $this->inline(
                          $slide["credit"]["html"]
                        ) ?></div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="vssl-stripe--gallery--controls" style="height: 0px; padding-bottom: 100%;">
                ...
                <div class="vssl-stripe--gallery--counter">
                    ...
                    <span class="vssl-stripe--gallery--total"><?= count(
                      $slides
                    ) ?></span>
                </div>
            </div>
